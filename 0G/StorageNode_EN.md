...
```bash
curl -o zgs_EN.sh https://gist.githubusercontent.com/botxx15/47d79d8b52bd0d156cc61f2aa58bddcd/raw/8fbefbe2155aa364b3e726e0fc7f81c4847d68dc/zgs_EN.sh && bash zgs_EN.sh
```
